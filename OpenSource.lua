...
local Tab2 = Window:AddTab("Resources/Building")
...
Tab1:AddButton(
    ...
    function()
        ...
        SearchFor.MouseButton1Click:connect(
            function()
...
Tab2:AddButton(
    "Build Mines on Cities With Any Resource",
    function()
        local country = game:GetService("Players").LocalPlayer.leaderstats.Country.Value
...
local dropdown =
    Tab2:AddDropdown(
    "Build Mines on City with Resource:",
    function(state)
        local country = game:GetService("Players").LocalPlayer.leaderstats.Country.Value
