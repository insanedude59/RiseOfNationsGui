...
Section1:CreateButton("Country Lookup",function()
  local  Country = Instance.new("ScreenGui")
            ...
            local Close = Instance.new("TextButton")
             ...
             Country.Parent = game.CoreGui
             Country.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
